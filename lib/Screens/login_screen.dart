  ...
  Future<void> _handleLogin() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        LoggerService.instance.info('Attempting login with username: $username');
        LoggerService.instance.debug('Mode: ${widget.isEmployeeMode ? "Employee" : "Citizen"}');
    ...
    password: password,
          ...
          if (widget.isEmployeeMode && isEmployeeRole) {
            LoggerService.instance.debug('Employee details: ${loginResponse.employeeDetails}');
            // Store employee details globally for later use
            ref.read(employeeDetailsProvider.notifier).state = loginResponse.employeeDetails;
            ...
            LoggerService.instance.warning('Role/mode mismatch: mode=' + (widget.isEmployeeMode ? 'Employee' : 'Citizen') + ', role=' + role);
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Icon(
                              widget.isEmployeeMode ? Icons.work : Icons.account_circle,
                              size: 48,
                          ...
                          // Title
                          Text(
                            widget.isEmployeeMode ? 'Employee Login' : 'Welcome Back',
                            style: TextStyle(
                              fontSize: 28,
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: widget.isEmployeeMode ? 'Employee ID' : 'Username',
                              hintText: widget.isEmployeeMode ? 'Enter your employee ID' : 'Enter your username',
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              child: _isLoading
                                  ...
                                  : Text(
                                      widget.isEmployeeMode ? 'Employee Login' : 'Login',
